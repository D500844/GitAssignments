...
# dBrady,2.22.2021,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    @staticmethod
    def add_data_to_list(task, priority, list_of_row):
    ...
    def remove_data_from_list(task, list_of_rows):
        # TODO: Add Code Here!
        #Used IO.input_task_to_remove for this
        return list_of_rows, 'Success'
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        #Used write data to file for this I believe
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        if strChoice.lower() == 'y':
            ...
            input("File data was not reloaded.")
